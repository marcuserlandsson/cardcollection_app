      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required minLength={6} className="w-full rounded-lg border border-[var(--border-light)] bg-[var(--elevated)] px-3 py-2.5 text-sm outline-none placeholder-[var(--text-dim)] transition-colors focus:border-[var(--accent)]" />
          </div>
